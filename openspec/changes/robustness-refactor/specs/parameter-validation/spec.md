...
1. 所有 SDK 公共方法的外部输入参数必须经过校验层。**方法级校验清单（入参字段、校验器、备注）**见变更文档 [`public-methods-validation-tasks.md`](../../public-methods-validation-tasks.md) 章节「24 方法校验矩阵」，并与 `sdk/quark_methods_b15_test.go` 中的导出方法表对照维护。
